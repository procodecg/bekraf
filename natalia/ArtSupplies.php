                ...
                <div class="header">
                    ...
                    <div class="search">
                        <form NAME="myform" ACTION="" METHOD=""><img src="search_icon.png" text-align=right width=40px:<br>
                            ...
                            <div class="row">
                                <div class="col-sm-3 bg-green center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Japanese Ribbon </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-orange center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Plastic Ribbon </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-green center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Fabric Ribbon </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-orange center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Organdy Ribbon </INPUT>
                                    <BR></BR>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-3 bg-orange center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Ribbon Lace </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-green center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Lace Hair Ribbon </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-orange center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> White Lace </INPUT>
                                    <BR></BR>
                                ...
                                <div class="col-sm-3 bg-green center">
                                    <INPUT TYPE="radio" NAME="rad" Value="rad_button1" onClick=0> Black Lace </INPUT>
                                    <BR></BR>
