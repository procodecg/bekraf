...
<div class="container">
  <div class="jumbotron">
    <img src="Little-Hands-Art-and-Craft.jpg" width="1020" height="500" padding="10 10 10 10" >
    <h1 class="titleheader">Welcome to Art and Craft world</h1>
    <h2>World of creative and fun!!<img src="anibutterfly21.gif" width="200" height="100"></h2> 
  </div>
<div class="header">
    <ul class="logo">
        <li>
